...
class NRGNN:
    ...
    def fit(self, features, adj, labels, idx_train, idx_val):
        ...
        # obtain the candidate edges linking unlabeled and labeled nodes
...
#         predictor_weights = torch.cat([predictor_weights_noisy_edge,predictor_weights],dim=0)
        ...
        self.estimator.label_smooth_weight(model_edge_index,features,representations)
        ...
        total_loss = loss_gcn + loss_pred + self.args.alpha * rec_loss  + self.args.beta * loss_add + loss_label_smooth * 1
...
#        
    ...
    def label_smooth_weight(self,edge_index,features,representations):
